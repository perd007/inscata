...
//contamos la cantidad de puestos selecconados	
  ...
  for($i=1;$i<=55;$i++){
	  ...
	  if($arreglo[$i]!=""){
  $insertSQL2 = sprintf("INSERT INTO reservacion (puesto, pasajero, salida, destino) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($arreglo[$i], "int"),
                       GetSQLValueString($_POST['cedula'], "int"),
  ...
  exit;
   ...
   echo "<script type=\"text/javascript\">alert ('Reservacion Realizada');  location.href='fondo.php' </script>";
  }
...
<? if($totalRows_pasajeros<1){?>
  <table align="center" class="lados">
    <tr valign="baseline" >
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5" class="negrita" >Reservacion de Pasajes</td>
    </tr>
    <tr valign="baseline">
...
45
  <label for="312">
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5"><input type="submit" class="negrita" value="Guardar Datos" /></td>
    </tr>
  </table>
<? }// fin del primer if ?>
