...
<body>
<form method="post" onsubmit="return validar()" name="form1" id="form1" action="consultar_reservacion_2.php">
  <p>&nbsp;</p>
  <table align="center" class="lados">
    <tr valign="baseline" >
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5" class="negrita" >Consulta de Reservaciones</td>
    </tr>
    <tr valign="baseline">
      <td width="88" align="left" nowrap="nowrap" bgcolor="#d8dfe5" class="izq">Salidas:</td>
      <td width="136" bgcolor="#d8dfe5"><label for="salida"></label>
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5"><input type="submit" class="negrita" value="Buscar" /></td>
    </tr>
  </table>
  <p>&nbsp;</p>
