...
<body>
<form method="post" onsubmit="return validar()" name="form1" id="form1" action="confirmar_reservacion_2.php">
  <p>&nbsp;</p>
  <table align="center" class="lados">
    <tr valign="baseline" >
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5" class="negrita" >Confirmar Reservaciones</td>
    </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5"><input type="submit" class="negrita" value="Buscar Datos" /></td>
    </tr>
  </table>
  <p>&nbsp;</p>
