...
function validar(){
			...
			var valor=confirm('¿Si confirmar esta salida ya no podra ser usada?');
			if(valor==false){
			return false;
			}
			else{
...
<body>
<form method="post" onsubmit="return validar()" name="form1" id="form1" action="confirmacion.php">
  <p>&nbsp;</p>
  <table width="255" align="center" class="lados">
    <tr valign="baseline" >
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5" class="negrita" >Confirmar Salida</td>
    </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#d8dfe5"><input type="submit" class="negrita" value="Confirmar" /></td>
    </tr>
  </table>
  <p>&nbsp;</p>
